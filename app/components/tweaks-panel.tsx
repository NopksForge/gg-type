...
interface RadioOptionObj { value: RadioOptionValue; label: string }
type RadioOption = RadioOptionValue | RadioOptionObj;

// ── useTweaks ───────────────────────────────────────────────────────────────

export function useTweaks<T extends object>(defaults: T): [T, (edits: Partial<T>) => void] {
...
export function TweakRadio({ label, value, options, onChange }: TweakRadioProps) {
  ...
  if (!fitsAsSegments) {
    const resolve = (s: string): RadioOptionValue => {
      ...
      return m === undefined ? s : typeof m === 'object' ? m.value : m as RadioOptionValue;
    };
    return <TweakSelect label={label} value={value} options={options}
                        onChange={(s) => onChange(resolve(s))} />;
  }

  const opts = options.map((o) => (typeof o === 'object' ? o : { value: o, label: String(o) })) as RadioOptionObj[];
...
interface TweakSelectProps {
  label: string; value: RadioOptionValue; options: RadioOption[];
...
interface TweakColorProps {
  label: string; value: ColorValue; options?: ColorValue[]; onChange: (v: ColorValue) => void;
}
